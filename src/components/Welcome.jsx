...
const Welcome = () => {
    return (
        <section className="text-left py-12 flex flex-col gap-3">
            ...
            <h1 className="text-2xl font-bold text-left">Full Stack & Mobile Dev, I ❤️ Javascript | REACT / Node.js / PHP</h1>
            <P>
                Full Stack Dev con más de 8 años de experiencia en aplicaciones web (PHP, Laravel, Codeigniter) y me encanta Javascript (React, React Native, NodeJS), he desarrollado aplicaciones móviles con Android, React Native y PWA. Me encanta diseñar soluciones desde el papel y lápiz hasta las bases de datos y siempre busco nuevos retos.
            </P>
